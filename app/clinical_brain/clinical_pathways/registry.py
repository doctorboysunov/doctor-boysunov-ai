...
def _bootstrap_pathways() -> None:
    ...
    _register(ClinicalPathway(
        ...
        nodes=(
            ...
            _node("un_associated", "unclassified_associated", "discriminator",
                  "Distribution/spread",
                  question_uz="Bu belgi tananing bir tomonida yoki ikkala tomonda ham bormi, va vaqt o'tishi bilan tarqalyaptimi?",
                  required=False,
                  depends_on=("unclassified_red_flags",),
                  clinical_info_label="Tarqalish va lokalizatsiya"),
            _node("un_duration", "unclassified_duration", "context",
                  "Duration/pattern",
                  question_uz="Bu holat doimiymi yoki vaqti-vaqti bilan takrorlanadimi? Oxirgi marta qachon kuchaygan?",
                  required=False,
                  depends_on=("unclassified_red_flags",),
                  clinical_info_label="Davomiylik va pattern"),
        ),
    ))
    ...
    _register(ClinicalPathway(
        ...
        nodes=(
            ...
            _node("gn_associated", "general_associated", "discriminator",
                  "Bu belgi tananing bir tomonida yoki ikkala tomonda ham bormi, va vaqt o'tishi bilan tarqalyaptimi?",
                  required=False,
                  depends_on=("general_red_flags",),
                  clinical_info_label="Tarqalish va lokalizatsiya"),
            _node("gn_duration", "general_duration", "context",
                  "Bu holat doimiymi yoki vaqti-vaqti bilan takrorlanadimi? Oxirgi marta qachon kuchaygan?",
                  required=False,
                  depends_on=("general_red_flags",),
                  clinical_info_label="Davomiylik va pattern"),
        ),
